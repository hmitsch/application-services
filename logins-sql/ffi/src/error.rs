        ...
        Ok((err, o)) => {
            if !out_error.is_null() {
                ...
                *eref = err;
                ...
                error!("Warning: an error occurred but no error parameter was given {:?}", err);
            }
            o
        }
        Err(e) => {
            if !out_error.is_null() {
                ...
                *eref = e.into();
                ...
                error!("Warning: a panic occurred but no error parameter was given {:?}", err);
            }
            None
        }
    }
